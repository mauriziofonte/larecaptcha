...
if (!function_exists('recaptcha')) {
    /**
     * @return Mfonte\ReCaptcha\ReCaptchaBuilder|\Mfonte\ReCaptcha\ReCaptchaBuilderV2|\Mfonte\ReCaptcha\ReCaptchaBuilderInvisible|\Mfonte\ReCaptcha\ReCaptchaBuilderV3
     */
    function recaptcha(): \Mfonte\ReCaptcha\ReCaptchaBuilder
    {
...
if (!function_exists('htmlFormSnippet')) {
     ...
     * @return string
     */
    function htmlFormSnippet(?string $id = 'recaptcha-element', ?string $class = 'g-recaptcha', ?array $attributes = []): string
    {
        return ReCaptcha::htmlFormSnippet($id, $class, $attributes);
    }
}
...
if (!function_exists('recaptchaRuleName')) {
    ...
    {
        return \Mfonte\ReCaptcha\ReCaptchaBuilder::DEFAULT_RECAPTCHA_RULE_NAME;
    }
}
...
if (!function_exists('recaptchaFieldName')) {
    ...
    {
        return \Mfonte\ReCaptcha\ReCaptchaBuilder::DEFAULT_RECAPTCHA_FIELD_NAME;
    }
}
